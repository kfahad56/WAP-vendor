...
const environment = process.env.REACT_APP_ENV ? process.env.REACT_APP_ENV : 'development'
...
export const token: string = _token + "5d41402abc4b2a76b9719d911017c592";
...
export const patchAPI = (url: string, params: string) => {
    const access_token = Cookie.get(token)
    return customFetch(_url + url, {
        method: "PATCH",
        headers: {
