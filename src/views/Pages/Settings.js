...
import * as managerAPI from "../../api/settings";
import * as activateAPI from "../../api/activate";
import { IconButton } from "@material-ui/core";
import CustomSnackbar from "views/Components/CustomSnackbar.js";
    ...
    return (
      <GridContainer>
        <CustomSnackbar
          ...
          severity={this.state.popup.severity}
          handleClose={() =>
            this.setState({
              popup: { ...defaultState.popup, message: this.state.message },
            })
          }
        />
