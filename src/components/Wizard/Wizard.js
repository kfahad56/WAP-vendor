        ...
        <Card className={classes.card}>
          ...
          <div className={classes.footer}>
            ...
            <div className={classes.right}>
              ...
              {this.state.step1Click ? (
                <Button
                  color="rose"
                  className={this.props.finishButtonClasses}
                  onClick={() => this.props.step1Click()}
                >
                  Save
                </Button>
              ) : null}
              {this.state.step2Click ? (
                <Button
                  color="rose"
                  className={this.props.finishButtonClasses}
                  onClick={() => this.props.step2Click()}
                >
                  Save
                </Button>
              ) : null}
              {this.state.step3Click ? (
                <Button
                  color="rose"
                  className={this.props.finishButtonClasses}
                  onClick={() => this.props.step3Click()}
                >
                  Save
                </Button>
              ) : null}
...
Wizard.propTypes = {
  ...
  step1Click: PropTypes.func,
  step2Click: PropTypes.func,
  step3Click: PropTypes.func,
};
