...
class Wizard extends React.Component {
  ...
  navigationStepChange(key) {
    if (this.props.steps) {
      ...
      // additional condition to make sure that tabs are not skipped
      if (
        validationState &&
        (key + 1 === this.state.currentStep ||
          key - 1 === this.state.currentStep)
      ) {
        this.setState({
          currentStep: key,
        ...
        <Card className={classes.card}>
          ...
          <div className={classes.footer}>
            ...
            <div className={classes.right}>
              ...
              {this.props.finishButton && this.state.finishButton ? (
                <Button
                  color="rose"
