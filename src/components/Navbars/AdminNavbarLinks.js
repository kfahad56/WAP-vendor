...
import { public_url } from "api/base";
...
export default function HeaderLinks(props) {
  ...
  const handleLogoutUser = () => {
    ...
    // localStorage.clear();
    // history.push(routeLayout.auth);
    window.location = `${public_url}logout`;
  };
                ...
                <ClickAwayListener onClickAway={handleCloseProfile}>
                  <MenuList role="menu">
                    {/* <MenuItem
                      onClick={() => {
                        props.history.push(
                          routeLayout.vendor + routePaths.editProfile
                        );
                        handleCloseProfile();
                      }}
                      className={dropdownItem}
                    ...
                    <MenuItem
                      onClick={() => {
                        props.history.push(
                          routeLayout.vendor + routePaths.settings
                        );
                        handleCloseProfile();
                      }}
                      className={dropdownItem}
